...
export const SERVICES_INDEX: Record<Lang, IndexCopy> = {
  en: {
    ...
    desc: 'Twelve cleaning services across Essex, Union, Morris, Middlesex and Hudson County, NJ — residential, commercial, deep, move-out and more. (908) 338-3160.',
  ...
  es: {
    ...
    desc: 'Doce servicios de limpieza en los condados de Essex, Union, Morris, Middlesex y Hudson, NJ: residencial, comercial, profunda, mudanza y más. (908) 338-3160.',
...
export const AREAS_INDEX: Record<Lang, IndexCopy> = {
  en: {
    ...
    desc: 'Genesis Cleaning works across Essex, Union, Morris, Middlesex and Hudson County, New Jersey. Find the county you are in. (908) 338-3160. Se habla español.',
  ...
  es: {
    ...
    desc: 'Genesis Cleaning trabaja en los condados de Essex, Union, Morris, Middlesex y Hudson, Nueva Jersey. Encuentra tu condado. (908) 338-3160.',

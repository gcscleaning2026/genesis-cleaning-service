    ...
    <div data-svcgrid="1">
      <article data-svc-feature="1" data-svccard="1" data-reveal="1" style="position:relative;overflow:hidden;border-radius:22px;background:linear-gradient(120deg,#E7F7FD 0%,#F8FCFE 60%,#FFFFFF 100%);border:1px solid #D3EBF6;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-start;justify-content:center;gap:13px;padding:clamp(26px,3vw,36px)">
          ...
          <h3 style="font-family:Outfit,sans-serif;font-size:clamp(20px,2.1vw,25px);font-weight:700;line-height:1.2;color:#0B1E4E;margin:0" data-i18n="svc.1.t">Commercial & Residential Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.2.t">Interior & Exterior Window Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.3.t">Standard Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.4.t">Move-In & Move-Out Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.5.t">Office Workplace Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.6.t">Apartment & Condo Cleaning</h3>
      ...
      <article data-svc-feature="1" data-svccard="1" data-reveal="1" style="position:relative;overflow:hidden;border-radius:22px;background:linear-gradient(120deg,#E7F7FD 0%,#F8FCFE 60%,#FFFFFF 100%);border:1px solid #D3EBF6;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-start;justify-content:center;gap:13px;padding:clamp(26px,3vw,36px)">
          ...
          <h3 style="font-family:Outfit,sans-serif;font-size:clamp(20px,2.1vw,25px);font-weight:700;line-height:1.2;color:#0B1E4E;margin:0" data-i18n="svc.7.t">Deep Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.8.t">Construction & Model Home Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.9.t">Clubhouse Cleaning</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.10.t">Gyms & Fitness Center Cleaning</h3>
      ...
      <article data-svc-feature="1" data-svccard="1" data-reveal="1" style="position:relative;overflow:hidden;border-radius:22px;background:linear-gradient(120deg,#FFF2F8 0%,#FFFFFF 72%);border:1px solid #F6D8E7;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-start;justify-content:center;gap:13px;padding:clamp(26px,3vw,36px)">
          ...
          <h3 style="font-family:Outfit,sans-serif;font-size:clamp(20px,2.1vw,25px);font-weight:700;line-height:1.2;color:#0B1E4E;margin:0" data-i18n="svc.11.t">Sanitizing & Disinfecting</h3>
      ...
      <article data-svccard="1" data-reveal="1" style="display:flex;flex-direction:column;overflow:hidden;border-radius:22px;background:#fff;border:1px solid #E3ECF3;transition:transform .22s ease,box-shadow .22s ease" style-hover="transform:translateY(-4px);box-shadow:0 20px 44px rgba(11,30,78,.12)">
        ...
        <div style="padding:40px 24px 26px">
          <h3 style="font-family:Outfit,sans-serif;font-size:18.5px;font-weight:700;line-height:1.25;color:#0B1E4E;margin:0 0 9px" data-i18n="svc.12.t">Vacation Rental Cleaning</h3>
